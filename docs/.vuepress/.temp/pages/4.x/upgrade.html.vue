...
<div class="language-diff ext-diff line-numbers-mode"><pre v-pre class="language-diff"><code>class DefaultApiSignProvider extends DefaultBaseApiSign
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>移除 <code v-pre>SettingRepository</code> 的 <code v-pre>setReRead()</code>, <code v-pre>save()</code> 方法</p>
...
<p>移除</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>\Poppy\System\Models\PamAccount::fetch()             :  多余的字段查询
...
<div class="language-diff ext-diff line-numbers-mode"><pre v-pre class="language-diff"><code>public function loginCheck(string $passport, string $password, string $guard_name = PamAccount::GUARD_WEB): bool
{
