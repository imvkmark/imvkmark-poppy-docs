...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>php artisan py-core:permission {slug}
{slug}:
    - list   : 获取权限列表
    - init   : 权限初始化
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>php artisan py-core:doc {slug}
{slug}:
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>$ composer global require overtrue/phplint -vvv
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>php artisan py-core:inspect {slug}
{slug} :
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>php artisan py-core:op {slug}
{slug} :
    - mail   : 发送运维邮件
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>$ php artisan vendor:publish --tag=poppy
...
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>$ php artisan py-core:doc php
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>$ php /path/of/doctum/doctum.phar update /path/of/doctum/config.php
 Updating project
...
<p>配置文件 : <a href="https://github.com/dadi-cn/poppy-core/blob/4.0/resources/config/doctum-config.php" target="_blank" rel="noopener noreferrer">doctum-config.php<ExternalLinkIcon/></a></p>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>'apidoc' => [
    ...
	'web' => [
        // 标题
        'title'            => '前台接口',
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>'rbac'       => [
    // 角色模型
...
<p>缓存一般采用如下命名</p>
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>sys_cache('{slug}')->get('{name}')
slug    : 根据模块目录来进行判定
...
<div class="language-php ext-php line-numbers-mode"><pre v-pre class="language-php"><code><span class="token php language-php"><span class="token delimiter important">&lt;?php</span> <span class="token keyword">namespace</span> <span class="token package">Poppy<span class="token punctuation">\</span>Area<span class="token punctuation">\</span>Classes</span><span class="token punctuation">;</span>
