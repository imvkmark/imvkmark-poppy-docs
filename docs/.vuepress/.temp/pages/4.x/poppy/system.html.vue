...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>参数的类型便是用户的类型, 这里的数据和 guard 起到映射关系, 但无需一致</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="platform" tabindex="-1"><a class="header-anchor" href="#platform" aria-hidden="true">#</a> platform</h3>
<blockquote>
<p>&gt; 4.0</p>
</blockquote>
<ul>
...
<p>接口请求的时候可以对注册平台进行设定, 用来扩充注册账号的平台</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>'platform'      => [
    'harmony' => '鸿蒙'
],
...
<p>[待定]支付类型</p>
<h3 id="sso-group" tabindex="-1"><a class="header-anchor" href="#sso-group" aria-hidden="true">#</a> sso_group</h3>
<ul>
<li>Type : <code v-pre>array</code></li>
<li>Default : <code v-pre>[]</code></li>
</ul>
<p>sso 单点登录的分组, 默认数据为</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>[
    'app:kicked' => ['android', 'ios'],
    'web.unlimited' => ['h5', 'webapp', 'mp']
];
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="使用-progress-方式数据表更新" tabindex="-1"><a class="header-anchor" href="#使用-progress-方式数据表更新" aria-hidden="true">#</a> 使用 Progress 方式数据表更新</h2>
...
<h2 id="sso-单点登录" tabindex="-1"><a class="header-anchor" href="#sso-单点登录" aria-hidden="true">#</a> SSO(单点登录)</h2>
<p>单点登录, 用于 Pam 的设备登录类型限定, 用于设备和设备之间的踢下线, 分组定义限制如下</p>
<div class="language-php line-numbers-mode" data-ext="php"><pre v-pre class="language-php"><code><span class="token string single-quoted-string">'sso_group'</span>             <span class="token operator">=></span> <span class="token punctuation">[</span>
    <span class="token string single-quoted-string">'app:kicked'</span>    <span class="token operator">=></span> <span class="token punctuation">[</span><span class="token string single-quoted-string">'android'</span><span class="token punctuation">,</span> <span class="token string single-quoted-string">'ios'</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
    <span class="token string single-quoted-string">'web:unlimited'</span> <span class="token operator">=></span> <span class="token punctuation">[</span><span class="token string single-quoted-string">'h5'</span><span class="token punctuation">,</span> <span class="token string single-quoted-string">'webapp'</span><span class="token punctuation">,</span> <span class="token string single-quoted-string">'android_h5'</span><span class="token punctuation">,</span> <span class="token string single-quoted-string">'ios_h5'</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">]</span><span class="token punctuation">,</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如上的定义, <code v-pre>kicked</code> 代表组内互踢, <code v-pre>unlimited</code> 代表不进行限制(也不会去记录用户的 Token 数据)</p>
</div></template>
