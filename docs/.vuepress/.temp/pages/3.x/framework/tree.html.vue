<template><div><h1 id="文件树" tabindex="-1"><a class="header-anchor" href="#文件树" aria-hidden="true">#</a> 文件树</h1>
<p>Poppy Framework 文档</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>├── README.md
├── composer.json
├── config
│   └── poppy.php
├── docs                   # 文档
